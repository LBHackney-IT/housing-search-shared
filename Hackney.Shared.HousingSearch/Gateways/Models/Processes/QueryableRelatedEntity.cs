...
namespace Hackney.Shared.HousingSearch.Gateways.Models.Processes
{
    public class QueryableRelatedEntity
    {
        ...
        public QueryableRelatedEntity(Guid id, string targetType, string subType, string description)
        {
            Id = id;
        ...
        public static QueryableRelatedEntity Create(Guid id, string targetType, string subType, string description)
        {
